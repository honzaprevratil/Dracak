...
{
    public class CacheLocation : INotifyPropertyChanged
    {
        /*
         * CACHED LOCATION
         * 
        ...
        public string CurrentLocationStory {
            ...
            {
                locationStory = value;
                SlowWriter.StoryFull = value;
                SlowWriter.StartWriting();
            }
        }

        public void MoveTo (int locationId)
        {
            CurrentLocation = DBhelper.GetWithChildrenById<Location>(locationId);
            //CurrentLocation = (Location)CurrentLocation.AdjacentLocations.Select(location => location.Id == locationId);
        }
        public void SlowSearch ()
        {
            CurrentLocationStory = CurrentLocation.SlowSearchText;
        }
        public void FastSearch()
        {
            CurrentLocationStory = CurrentLocation.FastSearchText;
        }
